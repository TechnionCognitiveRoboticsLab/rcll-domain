(define (problem rcll-production-031-durative)
  ...
  (:init
   ...
   (at 421 (not (order-delivery-window-open o2)))
   (order-cap-color o2 CAP_GREY)
   (order-gate o2 GATE-2)
   (order-complexity o3 c0)
   (order-base-color o3 BASE_BLACK)
   (at 460 (order-delivery-window-open o3))
   (at 562 (not (order-delivery-window-open o3)))
   ...
   (at 588 (order-delivery-window-open o5))
   (at 725 (not (order-delivery-window-open o5)))
   (order-ring1-color o5 RING_BLUE)
   (order-cap-color o5 CAP_GREY)
   (order-gate o5 GATE-3)
   (order-complexity o6 c2)
   (order-base-color o6 BASE_RED)
   (at 701 (order-delivery-window-open o6))
   (at 868 (not (order-delivery-window-open o6)))
   ...
   (at 623 (order-delivery-window-open o7))
   (at 783 (not (order-delivery-window-open o7)))
   ...
   (= (path-length C-BS OUTPUT C-CS1 OUTPUT) 9.830580)
   (= (path-length C-BS OUTPUT C-CS2 INPUT) 4.487610)
   (= (path-length C-BS OUTPUT C-CS2 OUTPUT) 5.221394)
   (= (path-length C-BS OUTPUT C-DS INPUT) 6.547272)
   (= (path-length C-BS OUTPUT C-DS OUTPUT) 4.798830)
   ...
   (= (path-length C-CS1 INPUT C-DS OUTPUT) 8.258060)
   ...
   (= (path-length C-CS1 OUTPUT C-DS OUTPUT) 7.836890)
   (= (path-length C-CS2 INPUT C-BS INPUT) 5.710607)
   (= (path-length C-CS2 INPUT C-BS OUTPUT) 4.487610)
   ...
   (= (path-length C-CS2 OUTPUT C-DS OUTPUT) 0.567240)
   ...
   (= (path-length C-DS OUTPUT C-BS OUTPUT) 4.798830)
   (= (path-length C-DS OUTPUT C-CS1 INPUT) 8.258060)
   (= (path-length C-DS OUTPUT C-CS1 OUTPUT) 7.836891)
   (= (path-length C-DS OUTPUT C-CS2 INPUT) 4.776323)
   (= (path-length C-DS OUTPUT C-CS2 OUTPUT) 0.567240)
