(define (problem rcll-production-081-durative)
  ...
  (:init
   ...
   (at 301 (order-delivery-window-open o3))
   ...
   (at 790 (not (order-delivery-window-open o5)))
   ...
   (at 789 (not (order-delivery-window-open o6)))
   ...
   (at 750 (not (order-delivery-window-open o7)))
...
(:goal (and    (order-fulfilled o2)  ; Announce 123
)))