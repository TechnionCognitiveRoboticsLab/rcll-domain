(define (problem rcll-production-085-durative)
  ...
  (:init
   ...
   (at 370 (order-delivery-window-open o2))
   (at 549 (not (order-delivery-window-open o2)))
   (order-cap-color o2 CAP_GREY)
   (order-gate o2 GATE-2)
   (order-complexity o3 c0)
   (order-base-color o3 BASE_BLACK)
   (at 569 (order-delivery-window-open o3))
   (at 735 (not (order-delivery-window-open o3)))
   ...
   (at 673 (not (order-delivery-window-open o5)))
   (order-ring1-color o5 RING_ORANGE)
   (order-cap-color o5 CAP_GREY)
   (order-gate o5 GATE-1)
   (order-complexity o6 c2)
   (order-base-color o6 BASE_BLACK)
   (at 640 (order-delivery-window-open o6))
   (at 778 (not (order-delivery-window-open o6)))
   ...
   (at 660 (order-delivery-window-open o7))
...
(:goal (and    (order-fulfilled o4)  ; Announce 573
)))