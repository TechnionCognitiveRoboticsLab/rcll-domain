(define (problem rcll-production-061-durative)
  ...
  (:init
   ...
   (at 822 (not (order-delivery-window-open o6)))
   ...
   (at 710 (order-delivery-window-open o7))
   (at 852 (not (order-delivery-window-open o7)))
...
(:goal (and    (order-fulfilled o2)  ; Announce 146
)))