(define (problem rcll-production-089-durative)
  ...
  (:init
   ...
   (at 318 (order-delivery-window-open o2))
   ...
   (at 631 (order-delivery-window-open o5))
   (at 748 (not (order-delivery-window-open o5)))
   ...
   (at 809 (not (order-delivery-window-open o6)))
   ...
   (at 663 (order-delivery-window-open o7))
   (at 798 (not (order-delivery-window-open o7)))
...
(:goal (and    (order-fulfilled o4)  ; Announce 610
)))