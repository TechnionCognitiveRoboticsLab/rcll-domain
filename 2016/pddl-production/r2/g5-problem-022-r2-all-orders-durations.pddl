(define (problem rcll-production-022-durative)
  ...
  (:init
   ...
   (at 359 (order-delivery-window-open o2))
   (at 521 (not (order-delivery-window-open o2)))
   ...
   (at 613 (order-delivery-window-open o5))
   (at 727 (not (order-delivery-window-open o5)))
   (order-ring1-color o5 RING_GREEN)
   (order-cap-color o5 CAP_BLACK)
   (order-gate o5 GATE-3)
   (order-complexity o6 c2)
   (order-base-color o6 BASE_RED)
   (at 613 (order-delivery-window-open o6))
   ...
   (at 755 (not (order-delivery-window-open o7)))
...
(:goal (and    (order-fulfilled o5)  ; Announce 227
)))