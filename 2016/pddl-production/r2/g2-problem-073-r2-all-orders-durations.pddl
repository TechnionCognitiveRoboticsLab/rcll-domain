(define (problem rcll-production-073-durative)
  ...
  (:init
   ...
   (at 441 (not (order-delivery-window-open o2)))
   (order-cap-color o2 CAP_BLACK)
   (order-gate o2 GATE-3)
   (order-complexity o3 c0)
   (order-base-color o3 BASE_RED)
   (at 523 (order-delivery-window-open o3))
   (at 694 (not (order-delivery-window-open o3)))
   ...
   (at 622 (order-delivery-window-open o7))
   (at 767 (not (order-delivery-window-open o7)))
...
(:goal (and    (order-fulfilled o2)  ; Announce 194
)))