(define (problem rcll-production-012-durative)
  ...
  (:init
   ...
   (at 609 (order-delivery-window-open o5))
   (at 734 (not (order-delivery-window-open o5)))
   (order-ring1-color o5 RING_ORANGE)
   (order-cap-color o5 CAP_GREY)
   (order-gate o5 GATE-1)
   (order-complexity o6 c2)
   (order-base-color o6 BASE_BLACK)
   (at 666 (order-delivery-window-open o6))
   (at 844 (not (order-delivery-window-open o6)))
   ...
   (at 684 (order-delivery-window-open o7))
   (at 822 (not (order-delivery-window-open o7)))
...
(:goal (and    (order-fulfilled o5)  ; Announce 166
)))