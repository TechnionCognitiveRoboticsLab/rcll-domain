(define (problem rcll-production-090-durative)
  ...
  (:init
   ...
   (at 491 (not (order-delivery-window-open o2)))
   (order-cap-color o2 CAP_GREY)
   (order-gate o2 GATE-1)
   (order-complexity o3 c0)
   (order-base-color o3 BASE_BLACK)
   (at 351 (order-delivery-window-open o3))
   (at 488 (not (order-delivery-window-open o3)))
   ...
   (at 648 (order-delivery-window-open o7))
...
(:goal (and    (order-fulfilled o6)  ; Announce 215
)))