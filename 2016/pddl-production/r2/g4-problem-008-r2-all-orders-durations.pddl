(define (problem rcll-production-008-durative)
  ...
  (:init
   ...
   (at 275 (order-delivery-window-open o2))
   ...
   (at 557 (not (order-delivery-window-open o3)))
   ...
   (at 581 (order-delivery-window-open o5))
   (at 694 (not (order-delivery-window-open o5)))
   ...
   (at 754 (not (order-delivery-window-open o7)))
   ...
   (= (path-length C-BS INPUT C-CS2 OUTPUT) 6.618160)
   ...
   (= (path-length C-BS OUTPUT C-CS2 OUTPUT) 5.434610)
   ...
   (= (path-length C-CS1 INPUT C-DS INPUT) 4.487620)
   ...
   (= (path-length C-CS2 OUTPUT C-BS INPUT) 6.618160)
   (= (path-length C-CS2 OUTPUT C-BS OUTPUT) 5.434610)
   ...
   (= (path-length C-DS INPUT C-CS1 INPUT) 4.487620)
   ...
   (= (path-length C-DS OUTPUT C-DS INPUT) 3.083660)
   ...
   (= (path-length START INPUT C-DS INPUT) 6.220680)
   (= (path-length START INPUT C-DS OUTPUT) 5.941535))

(:goal (and    (order-fulfilled o4)  ; Announce 642
)))