(define (problem rcll-production-026-durative)
  ...
  (:init
   ...
   (at 692 (order-delivery-window-open o5))
   (at 810 (not (order-delivery-window-open o5)))
   ...
   (at 849 (not (order-delivery-window-open o7)))
...
(:goal (and    (order-fulfilled o3)  ; Announce 420
)))