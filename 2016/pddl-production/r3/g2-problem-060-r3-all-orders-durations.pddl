(define (problem rcll-production-060-durative)
  ...
  (:init
   ...
   (at 356 (order-delivery-window-open o2))
   (at 515 (not (order-delivery-window-open o2)))
   (order-cap-color o2 CAP_BLACK)
   (order-gate o2 GATE-2)
   (order-complexity o3 c0)
   (order-base-color o3 BASE_SILVER)
   (at 501 (order-delivery-window-open o3))
   (at 578 (not (order-delivery-window-open o3)))
   ...
   (at 551 (order-delivery-window-open o5))
   (at 651 (not (order-delivery-window-open o5)))
   ...
   (at 746 (not (order-delivery-window-open o6)))
   ...
   (at 789 (not (order-delivery-window-open o7)))
...
(:goal (and    (order-fulfilled o2)  ; Announce 203
)))