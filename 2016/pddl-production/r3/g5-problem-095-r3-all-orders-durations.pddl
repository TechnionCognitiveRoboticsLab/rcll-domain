(define (problem rcll-production-095-durative)
  ...
  (:init
   ...
   (at 238 (order-delivery-window-open o2))
   ...
   (at 654 (order-delivery-window-open o3))
   (at 743 (not (order-delivery-window-open o3)))
   ...
   (at 659 (order-delivery-window-open o5))
   (at 773 (not (order-delivery-window-open o5)))
   (order-ring1-color o5 RING_YELLOW)
   (order-cap-color o5 CAP_BLACK)
   (order-gate o5 GATE-3)
   (order-complexity o6 c2)
   (order-base-color o6 BASE_RED)
   (at 600 (order-delivery-window-open o6))
   ...
   (at 656 (order-delivery-window-open o7))
   (at 806 (not (order-delivery-window-open o7)))
...
(:goal (and    (order-fulfilled o5)  ; Announce 182
)))