(define (problem rcll-production-041-durative)
  ...
  (:init
   ...
   (at 619 (order-delivery-window-open o7))
...
(:goal (and    (order-fulfilled o4)  ; Announce 508
)))