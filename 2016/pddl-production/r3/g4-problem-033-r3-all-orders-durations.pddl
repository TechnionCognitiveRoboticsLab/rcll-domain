(define (problem rcll-production-033-durative)
  ...
  (:init
   ...
   (at 251 (order-delivery-window-open o2))
   (at 334 (not (order-delivery-window-open o2)))
   (order-cap-color o2 CAP_BLACK)
   (order-gate o2 GATE-3)
   (order-complexity o3 c0)
   (order-base-color o3 BASE_SILVER)
   (at 334 (order-delivery-window-open o3))
   (at 423 (not (order-delivery-window-open o3)))
   ...
   (at 869 (not (order-delivery-window-open o6)))
   ...
   (at 735 (not (order-delivery-window-open o7)))
...
(:goal (and    (order-fulfilled o4)  ; Announce 602
)))