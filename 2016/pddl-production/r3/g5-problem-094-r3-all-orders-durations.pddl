(define (problem rcll-production-094-durative)
  ...
  (:init
   ...
   (at 649 (order-delivery-window-open o5))
   (at 775 (not (order-delivery-window-open o5)))
   (order-ring1-color o5 RING_ORANGE)
   (order-cap-color o5 CAP_GREY)
   (order-gate o5 GATE-3)
   (order-complexity o6 c2)
   (order-base-color o6 BASE_SILVER)
   (at 668 (order-delivery-window-open o6))
   (at 814 (not (order-delivery-window-open o6)))
   ...
   (at 651 (order-delivery-window-open o7))
   (at 773 (not (order-delivery-window-open o7)))
...
(:goal (and    (order-fulfilled o5)  ; Announce 183
)))