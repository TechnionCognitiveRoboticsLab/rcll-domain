(define (problem rcll-production-038-durative)
  ...
  (:init
   ...
   (at 865 (not (order-delivery-window-open o6)))
   ...
   (at 687 (order-delivery-window-open o7))
...
(:goal (and    (order-fulfilled o5)  ; Announce 139
)))