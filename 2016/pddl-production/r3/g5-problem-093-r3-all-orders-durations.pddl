(define (problem rcll-production-093-durative)
  ...
  (:init
   ...
   (at 765 (not (order-delivery-window-open o7)))
...
(:goal (and    (order-fulfilled o5)  ; Announce 217
)))