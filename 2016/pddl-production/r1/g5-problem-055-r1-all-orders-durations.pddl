(define (problem rcll-production-055-durative)
  ...
  (:init
   ...
   (at 472 (not (order-delivery-window-open o2)))
   (order-cap-color o2 CAP_BLACK)
   (order-gate o2 GATE-3)
   (order-complexity o3 c0)
   (order-base-color o3 BASE_BLACK)
   (at 476 (order-delivery-window-open o3))
   (at 574 (not (order-delivery-window-open o3)))
...
(:goal (and    (order-fulfilled o5)  ; Announce 320
)))