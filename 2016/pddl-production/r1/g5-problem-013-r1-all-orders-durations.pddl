(define (problem rcll-production-013-durative)
  ...
  (:init
   ...
   (at 757 (not (order-delivery-window-open o6)))
   ...
   (at 720 (order-delivery-window-open o7))
   (at 882 (not (order-delivery-window-open o7)))
...
(:goal (and    (order-fulfilled o5)  ; Announce 116
)))