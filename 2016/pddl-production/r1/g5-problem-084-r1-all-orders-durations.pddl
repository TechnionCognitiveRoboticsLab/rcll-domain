(define (problem rcll-production-084-durative)
  ...
  (:init
   ...
   (at 652 (order-delivery-window-open o5))
   ...
   (at 788 (not (order-delivery-window-open o7)))
...
(:goal (and    (order-fulfilled o5)  ; Announce 170
)))