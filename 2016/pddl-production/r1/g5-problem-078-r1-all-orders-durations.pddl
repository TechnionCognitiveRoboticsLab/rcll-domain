(define (problem rcll-production-078-durative)
  ...
  (:init
   ...
   (at 442 (not (order-delivery-window-open o2)))
   (order-cap-color o2 CAP_GREY)
   (order-gate o2 GATE-1)
   (order-complexity o3 c0)
   (order-base-color o3 BASE_BLACK)
   (at 315 (order-delivery-window-open o3))
   (at 451 (not (order-delivery-window-open o3)))
   ...
   (at 559 (order-delivery-window-open o5))
   (at 659 (not (order-delivery-window-open o5)))
   (order-ring1-color o5 RING_ORANGE)
   (order-cap-color o5 CAP_BLACK)
   (order-gate o5 GATE-1)
   (order-complexity o6 c2)
   (order-base-color o6 BASE_SILVER)
   (at 648 (order-delivery-window-open o6))
   (at 785 (not (order-delivery-window-open o6)))
...
(:goal (and    (order-fulfilled o5)  ; Announce 157
)))