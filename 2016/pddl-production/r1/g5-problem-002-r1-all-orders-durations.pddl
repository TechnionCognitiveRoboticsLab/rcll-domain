(define (problem rcll-production-002-durative)
  ...
  (:init
   ...
   (at 290 (order-delivery-window-open o2))
   (at 435 (not (order-delivery-window-open o2)))
   (order-cap-color o2 CAP_BLACK)
   (order-gate o2 GATE-1)
   (order-complexity o3 c0)
   (order-base-color o3 BASE_BLACK)
   (at 674 (order-delivery-window-open o3))
   (at 779 (not (order-delivery-window-open o3)))
   ...
   (at 676 (order-delivery-window-open o7))
   (at 834 (not (order-delivery-window-open o7)))
...
(:goal (and    (order-fulfilled o5)  ; Announce 269
)))