(define (problem rcll-production-043-durative)
  ...
  (:init
   ...
   (at 210 (order-delivery-window-open o2))
   (at 337 (not (order-delivery-window-open o2)))
   (order-cap-color o2 CAP_GREY)
   (order-gate o2 GATE-1)
   (order-complexity o3 c0)
   (order-base-color o3 BASE_RED)
   (at 401 (order-delivery-window-open o3))
   ...
   (at 586 (order-delivery-window-open o5))
   (at 683 (not (order-delivery-window-open o5)))
   ...
   (at 876 (not (order-delivery-window-open o6)))
   ...
   (at 692 (order-delivery-window-open o7))
...
(:goal (and    (order-fulfilled o4)  ; Announce 661
)))